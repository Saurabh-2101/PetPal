...
$text = $_POST['text'];
	...
	if($pick==' '||$drop==' '||$phone==' '||$fname==' '||$fmid==' '||$flast==' '||$zipcode==' '||$address==' '||$email==' '||$cardno==' '||$brand==''||$date==' '||$year==' '||$month==' '||$text==' ' )
	{
	...
	$sql = "INSERT INTO personal(p_id, pickup, dropoff, phone, first, mid, last, cod, address,email, cardno, cardbrand, ed, ey, em, message) VALUES ('$pick','$drop','$phone','$fname','$fmid','$flast','$zipcode','$address','$email','$cardno','$brand','$date','$year','$month','$text')";
	mysqli_query($db, $sql);
	
  echo '<div class="alert alert-success alert-dismissable fade in">';
 echo	'<a href="#" data-dismiss="alert" ></a>';
 echo 'Your Booking submit Successfully.';
echo  	'</div>';
	}
...
<?php						
				...
				echo		'<div class="map">';
					...
					echo			"<div class='' ><a href='admin/images/".$cimage." ' class='gal'><img src='admin/images/".$cimage." ' style='height:400px;width:1000;'></a></div>";
	...
	?>				
					...
					<div class="grid_6 prefix_1">
						...
						<form id="form" action=" " method="post">
							...
							<label class="name">
								<input  name='fmid' type="text" placeholder="Midname:" />
								
						
							</label>
							
							<label class="name">
								<input  name='flast' type="text" placeholder="Lastname:" />
							...
							<div>
								...
								<input style="color:blue" id='ds' type='submit' name='submit'  value='submit'   /></br>
						</form>
			...
			<div class="container_12">
				<div class="grid_12">
					...
					<div class="copy">
						...
						&copy; 2022	| <a href="#">Privacy Policy</a> </div> Website designed by <a href="#" rel="nofollow">Saurabh</a>
					</div>
				</div>
				<div class="clear"></div>
			</div>
