			...
			<div class="content">
				<div class="container_12">
					...
					<div class="grid_5">
						<h3>Contact Info</h3>
						<div class="map">
							<div class="text1 color2">Happy.Inc</div>
							<p>Don’t forget, 24/7 support is available for Happy.Inc  <span class="color1"></span> </p>
						
							<address>
								<dl>
									<dt>Happy corporation Inc. <br>
										47,Kevadiya colony,<br>
										Himmatnagar,Gujarat.
									</dt>
