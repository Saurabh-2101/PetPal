...
if(isset($_POST['submit']))
{
	...
	$query =mysqli_query($db,"SELECT * FROM 'admin_dir' WHERE username='$user_name' && password='$password'");
	$row=mysqli_num_rows($query);

	
	if($row = 1)
		{
				$_SESSION["admin_dir"] = 'admin_dir';
		...
		<div class="login-form-1">
			<div class="close-2"> </div>
				...
				<form action="<?php $_SELF_PHP ?>" method="post">
					<li>
						<input type="text" class="text" placeholder="Username" name="user_name" ><a href="#" class=" icon mail"></a>
					</li>
					<li>
